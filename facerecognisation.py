...
while True:
    ...
    if face_extractor(frame) is not None:
        ...
        file_name_path = 'C://Users//asd//Desktop//python file//workspace//facerecognisation//training//Anchal//' + str(count) + '.jpg'
...
person_dict = {"[0]": "Anchal Mall", "[1]": "Deepika Mall"}
person_dict_n = {"Anchal": "Anchal Mall", "Deepika(sister)": "Deepika Mall"}
